...
function enviar(destino){
  ...
  <div>
    <h1 id="titulo">Rechazar Solicitud</h1>

    <br />
  </div>
  <form id="formluario" name="formulario" method="post" >
    <h3>ID: </h3>
    <label><?php echo $id_solicitud ?></label>
    <h3>Docente: </h3>
    <label><?php echo $nombre_Docente . $apellido ?></label>
     <h3>Materia: </h3> 
     <label><?php echo $materia ?></label>
     <h3>Fecha de Solicitud:</h3>
     <label for=""><?php echo $fecha_solicitud ?></label>
     <h3>Fecha de Reserva:</h3>
     <label for=""><?php echo $fecha_reserva ?></label>
     <h3>Detalle:</h3>
     <label for=""><?php echo $detalle ?></label>
