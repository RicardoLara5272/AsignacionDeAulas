            ...
            <ul class="nav nav-tabs nav-pills" style="float:right;">
                <li class="nav-item dropdown active">
                    <div class="btn-group dropleft">
                        <a class="btn dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><ion-icon name="person-circle-outline" style="color: #fff; font-size: 30px; float: right;"></ion-icon></a>
